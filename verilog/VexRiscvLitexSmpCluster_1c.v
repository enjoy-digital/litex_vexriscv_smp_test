...
module VexRiscvLitexSmpCluster_1c (
  ...
  wire       [1:0]    iBusDecoder_io_outputs_0_downSizer_io_output_cmd_payload_fragment_context;
  ...
  wire       [1:0]    iBusDecoderToPeripheral_cmd_payload_fragment_context;
  ...
  wire       [1:0]    iBusDecoderToPeripheral_rsp_payload_fragment_context;
  ...
  wire       [1:0]    iBusDecoder_io_outputs_0_downSizer_io_output_cmd_halfPipe_payload_fragment_context;
  ...
  reg        [1:0]    iBusDecoder_io_outputs_0_downSizer_io_output_cmd_halfPipe_regs_payload_fragment_context;
  ...
  wire       [1:0]    iBusDecoderToPeripheral_rsp_m2sPipe_payload_fragment_context;
  ...
  reg        [1:0]    iBusDecoderToPeripheral_rsp_m2sPipe_rData_fragment_context;
  ...
  assign _zz_25 = ({2'd0,io_clint_ADR} <<< 2);
  assign _zz_26 = (_zz_19 && (! cluster_io_dMem_cmd_s2mPipe_ready));
  assign _zz_27 = (! cluster_io_iMems_0_cmd_halfPipe_regs_valid);
  assign _zz_28 = (! iBusDecoder_io_outputs_0_downSizer_io_output_cmd_halfPipe_regs_valid);
  assign _zz_29 = (! dBusDecoder_io_outputs_0_downSizer_io_output_cmd_halfPipe_regs_valid);
  assign _zz_30 = (clint_time - clint_harts_0_cmp);
  assign _zz_31 = io_clint_DAT_MOSI[31 : 0];
  assign _zz_32 = _zz_31;
  assign _zz_33 = io_clint_DAT_MOSI[31 : 0];
  assign _zz_34 = _zz_33;
  assign _zz_35 = io_clint_DAT_MOSI[0 : 0];
  VexRiscvSmpCluster cluster (
    .io_dMem_cmd_valid                          (cluster_io_dMem_cmd_valid                              ), //o
    .io_dMem_cmd_ready                          (_zz_19                                                 ), //i
    ...
    .io_iMems_0_rsp_valid                       (_zz_14                                                 ), //i
    .io_iMems_0_rsp_ready                       (cluster_io_iMems_0_rsp_ready                           ), //o
    .io_iMems_0_rsp_payload_last                (_zz_16                                                 ), //i
    .io_iMems_0_rsp_payload_fragment_opcode     (_zz_17                                                 ), //i
    .io_iMems_0_rsp_payload_fragment_data       (_zz_18[127:0]                                          ), //i
  ...
  BmbArbiter_1 iBusArbiter (
    ...
    .io_inputs_0_rsp_ready                       (_zz_13                                                          ), //i
  ...
  BmbDownSizerBridge iBusDecoder_io_outputs_0_downSizer (
    ...
    .io_output_cmd_payload_fragment_context    (iBusDecoder_io_outputs_0_downSizer_io_output_cmd_payload_fragment_context[1:0]   ), //o
    ...
    .io_output_rsp_payload_fragment_context    (iBusDecoderToPeripheral_rsp_m2sPipe_payload_fragment_context[1:0]                ), //i
    .clk                                       (clk                                                                              ), //i
    .reset                                     (reset                                                                            )  //i
  );
  ...
  BmbArbiter_2 peripheralArbiter (
    ...
    .io_inputs_0_cmd_payload_fragment_data       (_zz_21[31:0]                                                      ), //i
    .io_inputs_0_cmd_payload_fragment_mask       (_zz_22[3:0]                                                       ), //i
    .io_inputs_0_cmd_payload_fragment_context    (_zz_23[43:0]                                                      ), //i
  ...
  assign _zz_19 = (! cluster_io_dMem_cmd_s2mPipe_rValid);
  ...
  assign _zz_13 = ((1'b1 && (! _zz_14)) || cluster_io_iMems_0_rsp_ready);
  assign _zz_14 = _zz_15;
  assign _zz_20 = ((1'b1 && (! iBusArbiter_io_output_cmd_m2sPipe_valid)) || iBusArbiter_io_output_cmd_m2sPipe_ready);
  ...
  assign _zz_21 = 32'h0;
  assign _zz_22 = 4'bxxxx;
  assign _zz_23 = {42'd0, iBusDecoderToPeripheral_cmd_payload_fragment_context};
  ...
  assign iBusDecoderToPeripheral_rsp_payload_fragment_context = peripheralArbiter_io_inputs_0_rsp_payload_fragment_context[1:0];
  ...
  assign _zz_24 = ((1'b1 && (! peripheralArbiter_io_output_cmd_m2sPipe_valid)) || peripheralArbiter_io_output_cmd_m2sPipe_ready);
  ...
  always @ (posedge clk or posedge reset) begin
    if (reset) begin
      ...
      if(_zz_13)begin
        _zz_15 <= iBusArbiter_io_inputs_0_rsp_valid;
      end
      if(_zz_20)begin
      ...
      case(_zz_25)
        ...
        16'h0 : begin
          if(_zz_1)begin
            clint_harts_0_softwareInterrupt <= _zz_35[0];
          end
        end
        default : begin
        end
  ...
  always @ (posedge clk) begin
    clint_harts_0_timerInterrupt <= (! _zz_30[63]);
    if(_zz_26)begin
    ...
    if(_zz_13)begin
      _zz_16 <= iBusArbiter_io_inputs_0_rsp_payload_last;
      _zz_17 <= iBusArbiter_io_inputs_0_rsp_payload_fragment_opcode;
      _zz_18 <= iBusArbiter_io_inputs_0_rsp_payload_fragment_data;
    end
    if(_zz_20)begin
    ...
    case(_zz_25)
      ...
      16'h4000 : begin
        if(_zz_1)begin
          clint_harts_0_cmp[31 : 0] <= _zz_32;
        end
      end
      16'h4004 : begin
        if(_zz_1)begin
          clint_harts_0_cmp[63 : 32] <= _zz_34;
        end
      end
      16'h0 : begin
      end
...
module BmbToLiteDram (
  ...
  StreamFifoLowLatency_1 streamFifoLowLatency_4 (
...
module VexRiscv (
  ...
  initial begin
    $readmemb("VexRiscvLitexSmpCluster_1c.v_toplevel_cluster_cpus_0_core_RegFilePlugin_regFile.bin",RegFilePlugin_regFile);
  end
