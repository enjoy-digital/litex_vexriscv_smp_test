...
module VexRiscvLitexSmpCluster_1c (
  ...
  VexRiscvSmpCluster cluster (
    ...
    .io_iMems_0_rsp_valid                        (_zz_16                                                 ), //i
    .io_iMems_0_rsp_ready                        (cluster_io_iMems_0_rsp_ready                           ), //o
    .io_iMems_0_rsp_payload_last                 (_zz_18                                                 ), //i
  ...
  BmbArbiter_1 iBusArbiter (
    ...
    .io_inputs_0_rsp_ready                       (_zz_15                                                          ), //i
  ...
  always @ (posedge clk) begin
    ...
    if(_zz_15)begin
      _zz_18 <= iBusArbiter_io_inputs_0_rsp_payload_last;
